<script setup>
import { ref } from 'vue'
import { ElCard, ElInputNumber, ElMessage, ElMessageBox, ElRate } from 'element-plus'
  ...
  <div class="practice-section">
    ...
    <el-card class="box-card">
      ...
      <div class="card-body">
        ...
        <div class="input-group">
          <span>상품 만족도 별점:</span>
          <ElRate v-model="productRate" show-score score-template="{value} 점" />
        </div>
    ...
    <el-card class="box-card">
      <template #header> <strong>실습 3. 시스템 피드백 & 프로그레스 인터렉션</strong></template>
      <div class="card-body">
        <div class="btn-zone">
